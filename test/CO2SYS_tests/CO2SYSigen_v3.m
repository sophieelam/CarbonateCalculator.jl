function [PAR1, PAR2, PAR1TYPE, PAR2TYPE, SAL, pHSCALEIN, ...
    ...
    CO2SYSigen_v3(PARvalues, PARTYPEs, SALvalue, pHSCALEIN_opts, ...
...
% This version also maps KSO4CONSTANTS_opts values of 5 and 6 to
% (KSO4CONSTANT, BORON) values of (3, 1) and (3, 2) [2021-04-01]
...
PAR12ixs_all = nchoosek(1:numel(PARvalues), 2);
...
both2KSO4 = [1 2 1 2 3 3];
KSO4CONSTANT = both2KSO4(KSO4CONSTANTS)';
both2BSal = [1 1 2 2 1 2];
